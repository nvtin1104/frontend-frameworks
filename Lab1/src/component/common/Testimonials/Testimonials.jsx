                ...
                <div className="row">
                    <div className="col-md-6 mb-5" data-aos="fade-right" data-aos-delay="100">
                        ...
                        <div className="d-flex justify-content-end align-items-end">
                            ...
                            </div><img className="me-md-3 rounded" src="/src/assets/images/testimonials/client1.jpg" width="96" height="96" alt="client 1" />
                        </div>
                    </div>
                    <div className="col-md-6 mb-5" data-aos="fade-left" data-aos-delay="300">
                        ...
                        <div className="d-flex justify-content-end align-items-end">
                            <div className="text-end me-2">
                                ...
                                <div className="text-small">CEO / Web Design Company</div>
                            </div><img className="me-md-3 rounded" src="/src/assets/images/testimonials/client2.jpg" width="96" height="96" alt="client 1" />
                        </div>
                    </div>
                    <div className="col-md-6 mb-5" data-aos="fade-right" data-aos-delay="200">
                        ...
                        <div className="d-flex justify-content-end align-items-end">
                            ...
                            </div><img className="me-md-3 rounded" src="/src/assets/images/testimonials/client3.jpg" width="96" height="96" alt="client 1" />
                        </div>
                    </div>
                    <div className="col-md-6 mb-5" data-aos="fade-left" data-aos-delay="400">
                        ...
                        <div className="d-flex justify-content-end align-items-end">
                            ...
                            </div><img className="me-md-3 rounded" src="/src/assets/images/testimonials/client4.jpg" width="96" height="96" alt="client 1" />
                        </div>
                    </div>
                </div>
            </div>
